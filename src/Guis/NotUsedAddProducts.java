 ...
 * @author Kain
 */
public class NotUsedAddProducts extends javax.swing.JFrame {

    /**
     * Creates new form AddProducts
     */
    public NotUsedAddProducts() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NotUsedAddProducts.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NotUsedAddProducts().setVisible(true);
            }
        });
    }
